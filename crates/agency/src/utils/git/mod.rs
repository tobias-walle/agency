...
pub(crate) use command::{hard_reset_to_head_at, rebase_onto, stash_pop, stash_push};
...
pub(crate) use repo::{git_workdir, open_main_repo, repo_workdir_or, resolve_main_workdir};

// Re-export public APIs from worktree module
pub(crate) use worktree::{add_worktree_for_branch, prune_worktree_if_exists, prune_worktree_if_exists_at};
